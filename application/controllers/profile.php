	...
	class Profile extends CI_Controller
	{
		...
		function view($id)
		{
			...
			(
				"SELECT `%s`.`%s`, `%s` 
				FROM `%s`, `%s`
				WHERE `%s` = %d AND `%s`.`%s` = `%s`.`%s`",
				
				HealthCard::TABLE_NAME, HealthCard::CARD_NUMBER, HealthCard::CARD_NAME,
				
				HealthCard::TABLE_NAME, HealthCard::LOOKUP_TABLE_NAME,
				
				HealthCard::TRUE_ID, $id,
				HealthCard::TABLE_NAME, HealthCard::CARD_TYPE, 
				HealthCard::LOOKUP_TABLE_NAME, HealthCard::CARD_TYPE
			);
			$data["healthcards"] = $this->db->query($query)->result();
			...
			(
				...
				"order_list", "order_id", "order_line", "package_id", "quantity", "package_name", "package_price",
			...
			(
				...
				"billing_archive", "bill_no", "installment_no", "amount_deposited", "installment_date",
			...
			(
				...
				Appointment::VISIT_NUMBER, Appointment::APPOINTMENT_DATE,
			...
			$data["visits"] = $this->db->query($visit_query)->result();
			...
			(
				...
				"eye_exam_va", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_va", "visit_no"
			);
			$data["eye_exam_va"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_refraction", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_refraction", "visit_no"
			);
			$data["eye_exam_refraction"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_pupils", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_pupils", "visit_no"
			);
			$data["eye_exam_pupils"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_gross", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_gross", "visit_no"
			);
			$data["eye_exam_gross"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_slitlamp", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_slitlamp", "visit_no"
			);
			$data["eye_exam_slitlamp"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_strab_duction", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_strab_duction", "visit_no"
			);
			$data["eye_exam_strab_duction"] = $this->db->query($query)->result();
			
			// Strab fusional amplitudes
			$query = sprintf
			(
				"SELECT *
				 FROM `%s`, (%s) %s
				...
				"eye_exam_strab_fusional_amplitudes", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_strab_fusional_amplitudes", "visit_no"
			);
			$data["eye_exam_strab_fusional_amplitudes"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_strab_measurements", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_strab_measurements", "visit_no"
			);
			$data["eye_exam_strab_measurements"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_strab_version", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_strab_version", "visit_no"
			);
			$data["eye_exam_strab_version"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_stereoacuity", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_stereoacuity", "visit_no"
			);
			$data["eye_exam_stereoacuity"] = $this->db->query($query)->result();
			...
			(
				...
				"eye_exam_posterior", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "eye_exam_posterior", "visit_no"
			);
			$data["eye_exam_posterior"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_iop", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_iop", "visit_no"
			);
			$data["ancillary_iop"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_color", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_color", "visit_no"
			);
			$data["ancillary_color"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_utz", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_utz", "visit_no"
			);
			$data["ancillary_utz"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_retina_image", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_retina_image", "visit_no"
			);
			$data["ancillary_retina_image"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_ver", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_ver", "visit_no"
			);
			$data["ancillary_ver"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_eog", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_eog", "visit_no"
			);
			$data["ancillary_eog"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_oct_disc", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_oct_disc", "visit_no"
			);
			$data["ancillary_oct_disc"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_oct_macula", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_oct_macula", "visit_no"
			);
			$data["ancillary_oct_macula"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_oct_other", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_oct_other", "visit_no"
			);
			$data["ancillary_oct_other"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_vf", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_vf", "visit_no"
			);
			$data["ancillary_vf"] = $this->db->query($query)->result();
			...
			(
				...
				"ancillary_other", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "ancillary_other", "visit_no"
			);
			$data["ancillary_other"] = $this->db->query($query)->result();
			...
			(
				...
				"diagnosis", $visit_query, "VISITS",
				
				"VISITS", "visit_num", "diagnosis", "visit_no"
			);
			$data["diagnoses"] = $this->db->query($query)->result();
		...
		{	
			...
			if (count($sql) != 0)		// If patient with such ID exists
			{
				// Check if theres already an appointment
				$query = sprintf
				(
					"SELECT *
					 FROM `%s` 
					 WHERE `%s`.`%s` = %d AND `%s` IS NULL",
